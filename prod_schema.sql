...
CREATE TABLE IF NOT EXISTS "public"."audit_logs" (
    ...
    CONSTRAINT "audit_logs_action_check" CHECK (("action" = ANY (ARRAY['INSERT'::"text", 'UPDATE'::"text", 'DELETE'::"text", 'SELECT'::"text"])))
);
...
ALTER TABLE ONLY "public"."audit_logs"
    ADD CONSTRAINT "fk_audit_logs_user" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "admins_can_insert_settings" ON "public"."system_settings" FOR INSERT WITH CHECK (true);



CREATE POLICY "admins_can_manage_workout_types" ON "public"."workout_types" USING (true) WITH CHECK (true);



CREATE POLICY "admins_can_update_report" ON "public"."reports" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "admins_can_update_settings" ON "public"."system_settings" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "admins_read_reports" ON "public"."reports" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND (("users"."is_admin" = true) OR ("users"."is_super_admin" = true) OR ("users"."is_sub_admin" = true))))) OR true));
...
CREATE POLICY "public_read_challenge_participants" ON "public"."challenge_participants" FOR SELECT USING (true);
...
CREATE POLICY "public_read_club_feeds" ON "public"."club_feeds" FOR SELECT USING (true);
...
CREATE POLICY "public_read_club_workout_mileage" ON "public"."club_workout_mileage" FOR SELECT USING (true);
...
CREATE POLICY "public_read_workout_comments" ON "public"."workout_comments" FOR SELECT USING (true);



CREATE POLICY "public_read_workout_likes" ON "public"."workout_likes" FOR SELECT USING (true);



CREATE POLICY "public_read_workout_types" ON "public"."workout_types" FOR SELECT USING (true);



COMMENT ON POLICY "public_read_workout_types" ON "public"."workout_types" IS 'Public reference data. Updated only by admins through Functions.';



CREATE POLICY "public_read_workouts" ON "public"."workouts" FOR SELECT USING (true);



COMMENT ON POLICY "public_read_workouts" ON "public"."workouts" IS 'Allow public read access. Write operations handled by Netlify Functions.';
...
CREATE POLICY "service_role_insert" ON "public"."audit_logs" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "users_can_block" ON "public"."user_blocks" FOR INSERT WITH CHECK (true);



CREATE POLICY "users_can_comment" ON "public"."workout_comments" FOR INSERT WITH CHECK (true);



CREATE POLICY "users_can_create_challenge" ON "public"."challenges" FOR INSERT WITH CHECK (true);



CREATE POLICY "users_can_create_club" ON "public"."clubs" FOR INSERT WITH CHECK (true);



COMMENT ON POLICY "users_can_create_club" ON "public"."clubs" IS 'Allow all users to create clubs. App layer handles permissions.';



CREATE POLICY "users_can_create_feed" ON "public"."club_feeds" FOR INSERT WITH CHECK (true);



CREATE POLICY "users_can_create_workout" ON "public"."workouts" FOR INSERT WITH CHECK (true);



COMMENT ON POLICY "users_can_create_workout" ON "public"."workouts" IS 'Allow all users to create workouts. App layer handles user validation.';



CREATE POLICY "users_can_delete_challenge" ON "public"."challenges" FOR DELETE USING (true);



CREATE POLICY "users_can_delete_club" ON "public"."clubs" FOR DELETE USING (true);



CREATE POLICY "users_can_delete_feed" ON "public"."club_feeds" FOR DELETE USING (true);



CREATE POLICY "users_can_delete_mileage" ON "public"."club_workout_mileage" FOR DELETE USING (true);



CREATE POLICY "users_can_delete_own_comment" ON "public"."workout_comments" FOR DELETE USING (true);



CREATE POLICY "users_can_delete_workout" ON "public"."workouts" FOR DELETE USING (true);



CREATE POLICY "users_can_join_challenge" ON "public"."challenge_participants" FOR INSERT WITH CHECK (true);



CREATE POLICY "users_can_join_club" ON "public"."club_members" FOR INSERT WITH CHECK (true);



CREATE POLICY "users_can_leave_challenge" ON "public"."challenge_participants" FOR DELETE USING (true);



CREATE POLICY "users_can_leave_club" ON "public"."club_members" FOR DELETE USING (true);



CREATE POLICY "users_can_like" ON "public"."workout_likes" FOR INSERT WITH CHECK (true);



CREATE POLICY "users_can_record_mileage" ON "public"."club_workout_mileage" FOR INSERT WITH CHECK (true);



CREATE POLICY "users_can_report" ON "public"."reports" FOR INSERT WITH CHECK (true);



COMMENT ON POLICY "users_can_report" ON "public"."reports" IS 'Allow all users to submit reports. App layer handles validation.';



CREATE POLICY "users_can_unblock" ON "public"."user_blocks" FOR DELETE USING (true);



CREATE POLICY "users_can_unlike" ON "public"."workout_likes" FOR DELETE USING (true);



CREATE POLICY "users_can_update_challenge" ON "public"."challenges" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "users_can_update_club" ON "public"."clubs" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "users_can_update_feed" ON "public"."club_feeds" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "users_can_update_membership" ON "public"."club_members" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "users_can_update_mileage" ON "public"."club_workout_mileage" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "users_can_update_own_comment" ON "public"."workout_comments" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "users_can_update_participation" ON "public"."challenge_participants" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "users_can_update_workout" ON "public"."workouts" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "users_read_own_blocks" ON "public"."user_blocks" FOR SELECT USING (true);



CREATE POLICY "users_read_own_logs" ON "public"."audit_logs" FOR SELECT USING (true);
